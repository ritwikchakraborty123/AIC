...
if(isset($_POST['login']))
  {
    ...
    $sql ="SELECT hotel_email,hotel_password FROM tblvendor WHERE (hotel_email=:email)";
          ...
          <?php endif;?>
			...
			<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Email is reauired">
						...
						<input class="input100" type="email" name="email" placeholder="Type your registered email">
